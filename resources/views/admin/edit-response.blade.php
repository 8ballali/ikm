                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="/penilaian/admin/response/update/{{ $response->id }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="answer_id" class="form-control" placeholder="Response">


                                        <Option value='{{ $response->answer->answer }}'>{{ $response->answer->answer}}</Option>

                                    </select>
                                    {{-- <input type="text" name="answer_id" class="form-control" placeholder="Response"
